...
void IRPCFunc_VehicleDamaged(RPCParameters* rpcParams)
{
	...
	int uid = IRPC_VehicleDamaged->GetUID();
	pRakServer->RPC(&uid, &bsDamage, HIGH_PRIORITY, RELIABLE_ORDERED, 0, sender, TRUE, FALSE, UNASSIGNED_NETWORK_ID, NULL);
}