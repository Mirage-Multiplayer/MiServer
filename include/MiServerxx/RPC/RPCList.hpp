		...
		namespace RPC
		{
			...
			*/
			...
			struct ORPCServerJoin : public ORPC {
				...
				char PlayerName[256];  // Assumindo que o nome do jogador n�o ultrapasse 255 caracteres
			...
			struct ORPCInitGame : public ORPC {
				...
				UINT32 dLagCompMode;
				UINT8 length;
				char HostName[256];  // Assumindo que o nome do host n�o ultrapasse 255 caracteres
			...
			struct ORPCGameModeRestart : public ORPC {
				...
				void Write(RakNet::BitStream* bs) override {
					// N�o h� par�metros, apenas envia a RPC
				}
			};
			...
			struct ORPCApplyPlayerAnimation : public ORPC {
				UINT16 wPlayerID;
				UINT8 AnimLibLength;
				char AnimLib[256];  // Assumindo que a anima��o n�o ultrapasse 255 caracteres
				UINT8 AnimNameLength;
				char AnimName[256]; // Assumindo que o nome da anima��o n�o ultrapasse 255 caracteres
				float fDelta;
				bool loop;
				bool lockx;
				bool locky;
			...
			struct ORPCSetPlayerName : public ORPC {
				UINT16 wPlayerID;
				UINT8 NameLength;
				char Name[256];  // Assumindo que o nome do jogador n�o ultrapasse 255 caracteres
				UINT8 bSuccess;
			...
			struct ORPCSendClientMessage : public ORPC {
				...
				char Message[1024]; // Ajustar tamanho conforme necess�rio
			...
			struct ORPCSetShopName : public ORPC {
				UINT32 length;
				char Name[256]; // Ajustar tamanho conforme necess�rio
			...
			struct ORPCTextDrawSetString : public ORPC {
				UINT16 wTextDrawID;
				UINT16 TextLength;
				char Text[4096]; // M�ximo de 4096 caracteres
			...
			struct ORPCShowTextDraw : public ORPC {
				...
				UINT16 szTextLen;
				char szText[4096]; // M�ximo de 4096 caracteres
			...
			struct ORPCRemovePlayerFromVehicle : public ORPC {
				// Nenhum par�metro necess�rio para esse RPC.
				explicit ORPCRemovePlayerFromVehicle() : ORPC(71) {}

				void Write(RakNet::BitStream* bs) override {
					// N�o h� dados para escrever, apenas envie o RPC.
				}
			};
			...
			struct ORPCDisableCheckpoint : public ORPC {
				...
				void Write(RakNet::BitStream* bs) override {
					// Este RPC n�o possui par�metros, apenas � enviado.
				}
			};
			...
			struct ORPCChatBubble : public ORPC {
				...
				UINT32 expiretime;
				UINT8 textLength;
				char text[256];  // Ajuste o tamanho conforme necess�rio, ou use um ponteiro para gerenciar dinamicamente
